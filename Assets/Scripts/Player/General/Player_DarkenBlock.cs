...
public class Player_DarkenBlock : Singleton<Player_DarkenBlock>
{
    ...
    //    canMove_Forward = CheckIfCanMove(ref moveTarget_Forward, Movement.Instance.UpdatedDir(Vector3.forward));
    //    canMove_Back = CheckIfCanMove(ref moveTarget_Back, Movement.Instance.UpdatedDir(Vector3.back));
    //    canMove_Left = CheckIfCanMove(ref moveTarget_Left, Movement.Instance.UpdatedDir(Vector3.left));
    //    canMove_Right = CheckIfCanMove(ref moveTarget_Right, Movement.Instance.UpdatedDir(Vector3.right));
    //}
